...
const GlassGallery = () => {
  ...
  const galleryItems = [
    {
      id: 1,
      image: "/image/result/2024_isc.jpg",
      title: "ISC 2023",
      description: "In the ISC 2023 exams, VSN students achieved outstanding results, with many securing top positions and distinctions. Their success is a reflection of hard work, excellent teaching, and a supportive learning environment at the school. The remarkable performance highlights the dedication and commitment of both the students and faculty."
    },
    {
      id: 2,
      image: "/image/result/2024_isc.jpg",
      title: "ISC 2022",
      description: "VSN students have once again excelled in the ISC 2022 exams, with many securing top positions and distinctions. Their success is a testament to the hard work, dedication, and commitment of both the students and faculty. The outstanding performance reflects the high standards of teaching and learning at the school."
    },
    {
      id: 3,
      image: "/image/result/2024_isc.jpg",
      title: "ISC 2021",
      description: "VSN students have once again excelled in the ISC 2021 exams, with many securing top positions and distinctions. Their success is a testament to the hard work, dedication, and commitment of both the students and faculty. The outstanding performance reflects the high standards of teaching and learning at the school."
    },
    {
      id: 4,
      image: "/image/result/2024_isc.jpg",
      title: "ISC 2020",
      description: "VSN students have once again excelled in the ISC 2020 exams, with many securing top positions and distinctions. Their success is a testament to the hard work, dedication, and commitment of both the students and faculty. The outstanding performance reflects the high standards of teaching and learning at the school."
    }
  ];
  ...
  return (
    <>
      ...
      <div className="gallery-container">
        ...
        <h1 className="main-heading">Our Results Of ISC!</h1>
